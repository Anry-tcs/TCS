...
# Вывод 
Вывод: В данной лабораторной работе был реализован счётчик, который доходит до значения 8221371 и обнуляется, а после возобновляет счёт. Работа кода Verilog была проверена на ПЛИС. Результаты получились корректные. 
