...
Тактовую частоту: f_{clk} = 8 МГц

Период тактового сигнала: T_{clk}​ = 125

Длительность импульса : T_{pulse}​ = 8 мкс 
...
Период тактового сигнала: T_{clk}​ = 125
![](teo1.png)  
Длительность импульса (полуволны): T_{pulse}​ = 8 мкс 
![](teo2.png)  
...
Вывод: В данной лабораторной работе был реализованцифровой генератор NCO, проверена его работа с помощью тестбенча. Результаты симуляции были сравнены с теоретическими расчетами и потдвердили корректность графиков.
