...
Создание регистр сдвига с обратной связью, симуляция LSFR на ПЛИС и сравнение реализации с математической моделью на Python.
...
Вывод:
В данной лабораторной работе был реализован регистр сдвига с обратной связью, проверена его работа на ПЛИС. 
