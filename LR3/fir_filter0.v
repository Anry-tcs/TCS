module fir_filter (
    ...
    reg signed [15:0] r [35:0];
    wire signed [15:0] coeff [35:0];
    assign coeff[0] = 48;
    assign coeff[1] = -362;
    assign coeff[2] = 303;
    assign coeff[3] = -268;
    ...
    assign coeff[9] = 415;
    assign coeff[10] = 529;
    assign coeff[11] = -1705;
    assign coeff[12] = 2724;
    assign coeff[13] = -3074;
    assign coeff[14] = 2179;
    assign coeff[15] = 667;
    assign coeff[16] = -7188;
    assign coeff[17] = 32767;
    assign coeff[18] = 32767;
    assign coeff[19] = -7188;
    assign coeff[20] = 667;
    assign coeff[21] = 2179;
    assign coeff[22] = -3074;
    assign coeff[23] = 2724;
    assign coeff[24] = -1705;
    assign coeff[25] = 529;
    assign coeff[26] = 415;
    assign coeff[27] = -927;
    assign coeff[28] = 988;
    ...
    always @(posedge clk) begin
        if (rst) begin
            for (integer j=0; j<36; j=j+1) r[j] <= 0;
        end else begin
            r[0] <= in;
            r[1] <= r[0];
            r[2] <= r[1];
    ...
    assign mult[33] = r[33] * coeff[33];
    assign mult[34] = r[34] * coeff[34];
    assign mult[35] = r[35] * coeff[35];

    // Layer 0: 36 inputs -> 18 outputs
    wire signed [32:0] L0 [17:0];
    ...
    assign L0[16] = mult[32] + mult[33];
    assign L0[17] = mult[34] + mult[35];

    // Layer 1: 18 inputs -> 9 outputs
