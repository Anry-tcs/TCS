...
Графики в точности совпадают при наложении с теми, что получены с помощью Python
...
Для сравнения с графиком идёт ипусльный отклик из pyFDA

![](imp0.png)  

Графики в точности совпадают
...
Графики почти в точности совпадают при наложении с теми, что получены с помощью Python
...
Графики совпадают не полностью, из-за невозможности идеально настроить параметры для полосового фильтра по варианту в pyFDA
...
Файлы с коэффицентами полученные из pyFDA и Verilog код, полученный для каждого фильтра:
...
# Вывод
В данной лабораторной работе были созданы ФНЧ, ФВЧ и полосовой фильтр, с помощью кода Python были получены теоритические графики и сгенерированы RTL описания для каждого из них. В Vivado простестированы все три фильтра, результаты совпадают с теорией и подтвердил корректность выполнения работы, в условиях небольших сдвигов во времени.
