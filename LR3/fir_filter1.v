module fir_filter (
    ...
    reg signed [15:0] r [33:0];
    wire signed [15:0] coeff [33:0];
    assign coeff[0] = 322;
    assign coeff[1] = 644;
    assign coeff[2] = -575;
    assign coeff[3] = -505;
    ...
    assign coeff[8] = 1453;
    assign coeff[9] = 1748;
    assign coeff[10] = -2145;
    assign coeff[11] = -2646;
    assign coeff[12] = 3375;
    assign coeff[13] = 4463;
    assign coeff[14] = -6409;
    assign coeff[15] = -10831;
    assign coeff[16] = 32767;
    assign coeff[17] = -32767;
    assign coeff[18] = 10831;
    assign coeff[19] = 6409;
    assign coeff[20] = -4463;
    assign coeff[21] = -3375;
    assign coeff[22] = 2646;
    assign coeff[23] = 2145;
    assign coeff[24] = -1748;
    assign coeff[25] = -1453;
    assign coeff[26] = 1196;
    assign coeff[27] = 1007;
    assign coeff[28] = -831;
    assign coeff[29] = -666;
    assign coeff[30] = 505;
    assign coeff[31] = 575;
    ...
    always @(posedge clk) begin
        if (rst) begin
            for (integer j=0; j<34; j=j+1) r[j] <= 0;
        end else begin
            r[0] <= in;
            r[1] <= r[0];
            r[2] <= r[1];
